...
export const YouTube = (props) => {
  return (
      ...
      >
        <path
          fill={props.fill}
          d="M100.28 448H7.4V148.9h92.88zm-46.44-340C24.19 108 0 83.2 0 51.5 0 23.3 24.19 0 53.83 0a53.83 53.83 0 110 107.7zM447.9 448h-92.7V302.4c0-34.7-.7-79.4-48.4-79.4-48.4 0-55.8 37.8-55.8 76.9V448H158.6V148.9h89.1v40.8h1.3c12.4-23.5 42.6-48.4 87.7-48.4 93.7 0 111 61.7 111 141.9V448z"
        />
      </svg>
  );
};
